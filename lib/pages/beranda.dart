              ...
              children: <Widget>[
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 16.5 * MediaQuery.of(context).textScaleFactor,
                    fontWeight: FontWeight.bold,
                  ),
                ),
              ],
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              ...
                              subtitle: Text(
                                "Grand Theft Auto VI - Available Now",
                                style: TextStyle(
                                  fontSize: 15.5,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              title: Text(
                                "Ubihard Connect PC Beta - Oktober Update",
                                style: TextStyle(
                                  fontSize: 16.5,
                                  color: Color.fromARGB(255, 255, 255, 255),
                                  fontWeight: FontWeight.bold,
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                SizedBox(
                    width:
                        245), // Spacer untuk memberikan jarak antara teks "Top News" dan "View All".
                Text(
                  "View all",
                  style: TextStyle(
                      color: Color.fromARGB(255, 58, 88, 255),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                SizedBox(
                    width:
                        270), // Spacer untuk memberikan jarak antara teks "Top News" dan "View All".
                Text(
                  "View all",
                  style: TextStyle(
                      color: Color.fromARGB(255, 58, 88, 255),
